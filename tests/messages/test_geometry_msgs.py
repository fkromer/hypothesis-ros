...
def test_quaternion_accepts_customized_strategies(generated_value):
    ...
    assert generated_value == (1.0, 2.0, 3.0, 4.0)


@given(pose(position=point(x=float64(min_value=1.0, max_value=1.0),
                  y=float64(min_value=2.0, max_value=2.0),
                  z=float64(min_value=3.0, max_value=3.0)
                 ),
...
@given(vector3(x=float64(min_value=1.0, max_value=1.0),
               y=float64(min_value=2.0, max_value=2.0),
               z=float64(min_value=3.0, max_value=3.0)
              )
      )
